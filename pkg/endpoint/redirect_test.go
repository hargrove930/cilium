...
var (
	...
	mapKeyAllL7     = policy.Key{Identity: 0, DestPort: 80, PortMask: 0xffff, Nexthdr: 6, TrafficDirection: dirIngress}
	mapKeyFoo       = policy.Key{Identity: identityFoo, DestPort: 0, PortMask: 0xffff, Nexthdr: 0, TrafficDirection: dirIngress}
	mapKeyFooL7     = policy.Key{Identity: identityFoo, DestPort: 80, PortMask: 0xffff, Nexthdr: 6, TrafficDirection: dirIngress}
	mapKeyAllowAllE = policy.Key{Identity: 0, DestPort: 0, PortMask: 0xffff, Nexthdr: 0, TrafficDirection: dirEgress}
)
