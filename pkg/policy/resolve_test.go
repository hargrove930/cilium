...
func (ds *PolicyTestSuite) TestMapStateWithIngressWildcard(c *C) {
	...
	expectedEndpointPolicy := EndpointPolicy{
		...
		policyMapState: newMapState(map[Key]MapStateEntry{
			{PortMask: 0xffff, TrafficDirection: trafficdirection.Egress.Uint8()}: allowEgressMapStateEntry,
			{DestPort: 80, PortMask: 0xffff, Nexthdr: 6}:                          rule1MapStateEntry,
		}),
	}
...
func (ds *PolicyTestSuite) TestMapStateWithIngress(c *C) {
	...
	expectedEndpointPolicy := EndpointPolicy{
		...
		policyMapState: newMapState(map[Key]MapStateEntry{
			{PortMask: 0xffff, TrafficDirection: trafficdirection.Egress.Uint8()}:                              allowEgressMapStateEntry,
			{Identity: uint32(identity.ReservedIdentityWorld), DestPort: 80, PortMask: 0xffff, Nexthdr: 6}:     rule1MapStateEntry.WithOwners(cachedSelectorWorld),
			{Identity: uint32(identity.ReservedIdentityWorldIPv4), DestPort: 80, PortMask: 0xffff, Nexthdr: 6}: rule1MapStateEntry.WithOwners(cachedSelectorWorld),
			{Identity: uint32(identity.ReservedIdentityWorldIPv6), DestPort: 80, PortMask: 0xffff, Nexthdr: 6}: rule1MapStateEntry.WithOwners(cachedSelectorWorld),
			{Identity: 192, DestPort: 80, PortMask: 0xffff, Nexthdr: 6}:                                        rule1MapStateEntry.WithAuthType(AuthTypeDisabled),
			{Identity: 194, DestPort: 80, PortMask: 0xffff, Nexthdr: 6}:                                        rule1MapStateEntry.WithAuthType(AuthTypeDisabled),
		}),
	}
	...
	c.Assert(adds, checker.Equals, Keys{
		{Identity: 192, DestPort: 80, PortMask: 0xffff, Nexthdr: 6}: {},
		{Identity: 194, DestPort: 80, PortMask: 0xffff, Nexthdr: 6}: {},
	})
	c.Assert(deletes, checker.Equals, Keys{
		{Identity: 193, DestPort: 80, PortMask: 0xffff, Nexthdr: 6}: {},
	})
